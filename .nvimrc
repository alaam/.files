"  ___  _            ___  ___      _                               _ 
"  / _ \| |           |  \/  |     | |                             | |
" / /_\ \ | __ _  __ _| .  . | __ _| |__  _ __ ___   ___  _   _  __| |
" |  _  | |/ _` |/ _` | |\/| |/ _` | '_ \| '_ ` _ \ / _ \| | | |/ _` |
" | | | | | (_| | (_| | |  | | (_| | | | | | | | | | (_) | |_| | (_| |
" \_| |_/_|\__,_|\__,_\_|  |_/\__,_|_| |_|_| |_| |_|\___/ \__,_|\__,_|
"
...
" Required:
  ...
  call dein#add('vimlab/mdown.vim')
...
" autocmd BufEnter *.md exe 'noremap <F5> :!start  /Applications/Google\ Chrome.app %:p<CR>'
